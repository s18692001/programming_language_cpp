...
//of the array is 20 x 20.  The reason for this is to make the 
...
void copy(int array1[20][20], int array2[20][20])
{
	for (int j = 0; j < 20; j++)
	{
		for (int i = 0; i < 20; i++)
...
void life(int array[20][20], char choice)
{
...
int main()
{
	...
	do
	{
		...
		do
		{
			...
			srand(time(NULL));
			//The actual array is 20 x 20, but it's easier to just leave the surrounding part of
